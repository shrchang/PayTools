...
/**
 * 安全加密之基础公共工具类，该类不依赖于其他非sun实现的第三方类库,该类库仅支持jdk1.6支持的数字签名算法，其他签名算法的封装实现，
 * 可调用ExtendSecurityUtil类的相关方法
 * 
 * @author xuguolong
 * @date 20160816
 * @version 1.0.0
...
public class SunSecurityUtil {
	 ...
	 *            密钥库的管理密码
	 * @param keyStoreType
	 *            密钥库类型，仅支持Java本身支持的密钥库类型，JKS, JCEKS, PKCS12三种类型的密钥库
	 * @return
	 * @throws Exception
	 */
	 ...
	 * 
	 * @param cert
	 *            公钥字节数组，即publicKey.getEncoded()获得的字节数组
	 *            一般来说，保存时候，通过Base64.encoded(publicKey.getEncoded())，在使用的时候，
	 *            在解码使用，
	...
	/**
	 * 根据公钥的 Base64 X.509格式的字符串来生成公钥对象 公钥的
	 * Base64编码X.509格式的字符串，即从浏览器导出的.cer证书文件中的内容。 例如： -----BEGIN CERTIFICATE-----
	 * MIIEHjCCAwagAwIBAgIUOtZmoN484tQsbqkW5EhMYC/
	 * gikUwDQYJKoZIhvcNAQEFBQAwgZYxCzAJBgNVBAYTAkNOMTkwNwYDVQQKDDDljJfkuqzlpKnlqIHor5rkv6HnlLXlrZDllYbliqHmnI3liqHmnInpmZDlhazlj7gxFTATBgNVBAsMDOS8geS4muivgeS5pjE1MDMGA1UEAwws5aSp5aiB6K
	 * +a5L+h5pWw5a2X6K6k6K+B5Lit5b+D5LyB5Lia6K+
	 * B5LmmQ0EwHhcNMTYwODA3MTA0NzA0WhcNMTcwODA3MTA0NzA0WjB1MScwJQYDVQQKDB7lpKnlqIHor5rkv6HmlbDlrZforqTor4HkuK3lv4MxGDAWBgNVBAsMD
	 * +eUteWtkOWVhuWKoemDqDEwMC4GA1UEAwwn5bm/5bee5LiA5oyH6YCa5L+
	 * h5oGv56eR5oqA5pyJ6ZmQ5YWs5Y+
	 * 4MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAsZ4styCNSPROFEoThM8ry2+
	 * RhLxTA3B9wkbFBlXWlKNX/4tJpOo0H8yEv1fYZPUVc39PCPGbQ3YTU90jDUxmaBlLyvfS4/
	 * Zfb3hoPUArVKjUDjO3rI7Om1UF+wLkapKeyLgsZZJ+cO8tHfvb+rqlrFLtWYZuUOgj/
	 * jTNNq08yogFomhgW36xSWJGFAMzArebPf6/hOAgQyxUJc5lMqPHs/X/
	 * GzAQKugGMMwEUP9Or4JjiGdemsfRO4PoY5Ybya3uXWW46qCZa8YPjFDJf5daAs67A26YEvzHOr03Whpre345GJnkh0aj9ottwvyrPI
	 * +
	 ...
	 * +lsz4arsdi8D0n4eRygHtNbNSEYTxyP2Ah+uWhSuhv8O2dWeHsm78bmSeF7Oy3QQQvL/Rer+/
	 * 7Zv6qq2DkGIwisXJ5cc7LkALI9XrEu+
	 * 0wZ9MmFcWR6TTwty3F9UlGw8CdJnB4HGWSsFOEVM0R68v9mFX3yZELiv4WEqwdxvaAep12QLOKJ8t
	 * +I0AFmxyJUhTZB+Clzu3jNg8anOyJwSnhMJNEEh+q7E1e+LgH5CLnP/
	 * sx5o5xlNbIyIcXZaF42KBY5heuQZVgS66ugColythiiYsYeX8Uycxie1M= ----END
	 * CERTIFICATE-----
	 * 
	 * @param Base64X509String
	 *            公钥的 Base64编码X.509格式的字符串
	 * @return
	 * @throws Exception
	 */
	...
	/**
	 * 根据公钥的 Base64 X.509格式的字符串来获取证书对象 公钥的
	 * Base64编码X.509格式的字符串，即从浏览器导出的.cer公钥证书文件中的内容。 例如： -----BEGIN
	 * CERTIFICATE----- MIIEHjCCAwagAwIBAgIUOtZmoN484tQsbqkW5EhMYC/
	 * gikUwDQYJKoZIhvcNAQEFBQAwgZYxCzAJBgNVBAYTAkNOMTkwNwYDVQQKDDDljJfkuqzlpKnlqIHor5rkv6HnlLXlrZDllYbliqHmnI3liqHmnInpmZDlhazlj7gxFTATBgNVBAsMDOS8geS4muivgeS5pjE1MDMGA1UEAwws5aSp5aiB6K
	 * +a5L+h5pWw5a2X6K6k6K+B5Lit5b+D5LyB5Lia6K+
	 * B5LmmQ0EwHhcNMTYwODA3MTA0NzA0WhcNMTcwODA3MTA0NzA0WjB1MScwJQYDVQQKDB7lpKnlqIHor5rkv6HmlbDlrZforqTor4HkuK3lv4MxGDAWBgNVBAsMD
	 * +eUteWtkOWVhuWKoemDqDEwMC4GA1UEAwwn5bm/5bee5LiA5oyH6YCa5L+
	 ...
	 *            待签名数据
	 * @param algorithm
	 *            签名算法，这里仅支持由Java实现的一些签名算法，MD2withRSA\MD5withRSA\SHA1withRSA\
	 *            SHA256withRSA\SHA1withDSA
	 * @param privateKey
	 *            私钥对象实例
	 * @return byte[]数字签名结果
	 * @throws Exception
