...
/**
 * 佳联微信的签名 加解密工具
 * @ClassName SignEncryptDncryptSignChk
 * @author shrChang.Liu
 * @Description TODO
 * @date 2018年6月27日 下午7:26:56
 *
 */
public class SignEncryptDncryptUtil {
...
//		}
	...
	public static String sign(String sign, String context) {
		...
		String signInfo = JsonUtil.getJsonStrByObj(paramMap); // 待加密字符串
		return signInfo;
	}
...
//		String certAbsPath = Config.getProperty("merchantPublicKey");
//		Map<String, Object> paraMap = JsonUtil.getObjectByJsonStr(dncryptContext, Map.class);
